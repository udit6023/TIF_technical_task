...
class SearchEventModal {
  Content? content;
  bool? status;
  String? error;
  SearchEventModal({this.content, this.status});

  SearchEventModal.fromJson(Map<String, dynamic> json) {
    content =
        json['content'] != null ? new Content.fromJson(jsonDecode(json['content'])) : null;
    status = json['status'];
  }

 SearchEventModal.withError(String errorMessage) {
    error = errorMessage;
  }
...
class Content {
  ...
  Content.fromJson(Map<String, dynamic> json) {
    ...
    meta = json['meta'] != null ? new Meta.fromJson(jsonDecode(json['meta'])) : null;
  }
